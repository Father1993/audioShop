...
export const metadata: Metadata = {
  ...
  description:
    'Автомагнитолы и авто-звук по самым низким ценам в городе! Огромный выбор брендов и моделей. Быстрая доставка и установка. Не упусти возможность обновить звук в своей машине! Профессиональная установка автозвука в Хабаровске. Быстрая доставка. Качество. Гарантия. Премиум. Спешите купить',
  keywords:
